 ...
 *
 * @param <C> checkpoint type.
 * @param <I> item type.
 */
public interface TypedItemReader<C extends Serializable, I> {
	 ...
	 */
	default void open(C checkpoint) throws Exception {
		// no-op
	}
	/**
	 ...
	 * @throws Exception is thrown for any errors.
	 */
	default C checkpointInfo() throws Exception {
		return null;
	}
