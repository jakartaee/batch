 ...
 */
public interface TypedItemProcessListener<I, O> {
	 ...
	 */
	void beforeProcess(I item) throws Exception;
	/**
	 ...
	 * @throws Exception if an error occurs.
	 */
	void afterProcess(I item, O result) throws Exception;
	/**
	 ...
	 * @throws Exception if an error occurs
	 */
	void onProcessError(I item, Exception ex) throws Exception;
