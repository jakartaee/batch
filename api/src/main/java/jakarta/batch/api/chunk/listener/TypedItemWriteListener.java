 ...
 * @param <I> items type.
 */
public interface TypedItemWriteListener<I> {
	 ...
	 */
	void beforeWrite(List<I> items) throws Exception;
	/**
	 ...
	 * @throws Exception is thrown if an error occurs.
	 */
	void afterWrite(List<I> items) throws Exception;
	 ...
	 * @throws Exception is thrown if an error occurs.
	 */
	void onWriteError(List<I> items, Exception ex) throws Exception;
}
