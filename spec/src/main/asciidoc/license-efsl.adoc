...
* All existing copyright notices, or if one does not exist, a notice
  ...
  of the form: "Copyright (c) [$date-of-document] Eclipse Foundation, Inc. https://www.eclipse.org/legal/efsl.php[]"
...
document includes material copied from or derived from https://jakarta.ee/specifications/batch/2.0/[Jakarta Batch 2.0]."
